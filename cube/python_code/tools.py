...
sys.path.append('/home/ubuntu/cube/mofang/cube/python_code/code/solvers/cube3/')
...
from cube.python_code.code.environments import env_utils
import socket
import gc
from cube.python_code.code.ml_utils import nnet_utils
from cube.python_code.code.ml_utils import search_utils
...
def getResults(state):
    ...
    parser.add_argument('--methods', type=str, default="kociemba", help="Which methods to use. Comma separated list")
    ...
    parser.add_argument('runserver', type=str, default="", help="Special name to append to file name")
    parser.add_argument('0.0.0.0:9999', type=str, default="", help="Special name to append to file name")
    ...
    ### Save data
    arr = data['solutions'][methods[0]][0]
    moves = []
    moves_rev = []
    solve_text = []
    for i in arr:
